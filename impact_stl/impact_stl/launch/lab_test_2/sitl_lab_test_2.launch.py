...
def generate_launch_description():
    ...
    lf_1 = IncludeLaunchDescription(
        ...
        launch_arguments={'id': '1', 'pose': '0,0.5,0', 'name': 'crackle', 'delay': '0'}.items()
    )
    ...
    lf_2 = IncludeLaunchDescription(
        ...
        launch_arguments={'id': '2', 'pose': '0,3,0', 'name': 'pop', 'delay': '4'}.items()
    )
    ...
    lf_3 = IncludeLaunchDescription(
        ...
        launch_arguments={'id': '0', 'pose': '0.5,1.5,0', 'name': 'snap', 'delay': '8'}.items()
    )
    ld.add_action(lf_1)
    ld.add_action(lf_2)
    ld.add_action(lf_3)
