...
def generate_launch_description():
    ...
    lf_1 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'0', 'pose':'2,-2,0', 'name':'snap', 'delay':'0', 'headless':'0'}.items()
    )
    ...
    lf_2 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'1', 'pose':'-7,-2,0', 'name':'crackle', 'delay':'5', 'headless':'0'}.items()
    )
    ...
    lf_3 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'2', 'pose':'0,0,0', 'name':'pop', 'delay':'10', 'headless':'0'}.items()
    )
    ld.add_action(lf_1)
    ld.add_action(lf_2)
    ld.add_action(lf_3)
